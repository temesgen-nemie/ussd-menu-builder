                  ...
                  {isLoading ? (
                    ...
                    <div className="w-full bg-[#1c1c1e] rounded-[1.8rem] overflow-hidden shadow-2xl text-white animate-in zoom-in-95 duration-200">
                      ...
                      <div className="p-4 flex flex-col min-h-0">
                        ...
                        <div className={`overflow-y-auto overflow-x-hidden pr-2 scroll-smooth custom-scrollbar ${
                          messages.length > 0 && messages[messages.length-1].serviceType === 'EF' 
                            ? 'max-h-[240px] mb-2' 
                            : 'max-h-[180px] mb-3'
                        }`}>
                          <p className={`font-medium leading-[1.35] select-none whitespace-pre-wrap text-left break-words max-w-full ${
                            messages.length > 0 && messages[messages.length - 1].type === 'system'
                              ? messages[messages.length - 1].content.length > 140
                                ? "text-[12px]"
